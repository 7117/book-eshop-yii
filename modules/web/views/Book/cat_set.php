...
StaticService::includeAppJsStatic("/js/web/book/cat_set.js",['depends' => \app\assets\WebAsset::className()]);
?>
    ...
    <div class="col-lg-12">
        ...
        <div class="form-horizontal m-t m-b">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="weight" class="form-control" placeholder="请输入分类名称" value="<?=$info?$info['weight']:''?>">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
