...
StaticService::includeAppJsStatic("/js/web/member/set.js",["depends" => app\assets\WebAsset::className()]);
?>
    ...
    <div class="col-lg-12">
        ...
        <div class="form-horizontal m-t">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" placeholder="请输入会员名称" name="nickname" value="<?=$info ? $info['mobile']:''?>">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
